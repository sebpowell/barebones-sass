/* http://prismjs.com/download.html?settings=prism&languages=markup+css+clike+javascript+sass+scss */
...
function setNavigation() {
    ...
    $(".docs-navigation a").each(function () {
...
function setNavigation() {
    ...
    $(".docs-navigation a").each(function () {
        var href = $(this).attr('href');
        // alert(href);
        var sub = path.substring(4, href.length);
        alert(sub);
        if (sub === href) {
           $(this).closest('li').addClass('active');
        }
...
function setNavigation() {
    ...
    $(".docs-navigation a").each(function () {
        var href = $(this).attr('href');
        // alert(href);
        var sub = path.substring(2, href.length);
        alert(sub);
        if (sub === href) {
           $(this).closest('li').addClass('active');
        }
